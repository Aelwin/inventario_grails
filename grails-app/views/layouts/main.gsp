...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="list" controller="lectura" action="index"><g:message code="lectura.list" /></g:link></li>
        ...
        <li><g:link class="create" controller="lectura" action="create"><g:message code="default.new.label" args="[message(code:'lectura.label')]" /></g:link></li>
